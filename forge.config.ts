...
const config: ForgeConfig = {
  ...
  makers: [
    new MakerSquirrel({
      // Own Squirrel package name so it installs next to (instead of over) the app this is based on
      name: "youtube_music_premium",
      title: "YouTube Music Premium",
      setupExe: "YouTube Music Premium Quick Setup.exe",
      setupIcon: "./src/assets/icons/ytmd.ico",
      // Generated by scripts/generate-installer-image.py
      loadingGif: "./src/assets/installer/squirrel-loading.gif",
      noMsi: true
    }),
    new MakerZIP({}, ["darwin"]),
    new MakerRpm({
